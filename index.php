...
<body>
    ...
    <!-- Hero Section -->
    <div class="bg-[url('./image/imagetest.webp')] h-screen bg-cover bg-center text-white grayscale-[100%] flex">
        <h1 class="m-auto font-bold text-6xl w-[80%] md:w-[50%] md:leading-relaxed text-center">Your Dream Wedding Made Perfect</h1>
    </div>

    <!-- About Us Section -->
    <div class="py-10 flex flex-col gap-7 w-[90%] lg:w-[60%] mx-auto">
        <div class="flex flex-col text-center">

            <h2 class="font-medium text-lg text-[#80B9AD]">- About Us -</h2>
            <h1 class="font-bold text-4xl">Who We Are</h1>
        </div>
        <div class="flex flex-col gap-4 lg:gap-0 lg:gap-6 lg:flex-row items-center justify-between w-full">
            <img src="./image/imgAboutUs.jpg" alt="About Us" class="rounded-md w-[60%] lg:w-fit">
    ...
    <div class="py-10 flex flex-col gap-7 w-[60%] min-h-full mx-auto">
        ...
        <div class="grid gridcols-1 lg:grid-cols-3 gap-4">
            <div class="flex flex-col gap-1 border p-4 bg-white shadow-md text-center justify-center items-center rounded-lg">
