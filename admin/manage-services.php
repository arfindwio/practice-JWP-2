    ...
    <div class="flex w-full">
        ...
        <div class="flex flex-col h-screen w-auto gap-8 md:w-[78%] bg-slate-100">
            ...
            <div class="flex flex-col gap-1 flex-wrap px-5">
                ...
                <a href="/arfindwio/admin/create-service.php" class="px-4 py-2 bg-green-400 w-fit rounded-md hover:bg-green-600 text-white">Create Service</a>
                    ...
                    <tbody class="border border-collapse">
                        ...
                        if ($result->num_rows > 0) {
                            ...
                            while ($row = $result->fetch_assoc()) {
                                ?>
                                <tr>
                                    <td class='py-2 border px-2'><?php echo $index++; ?></td>
